...
// source: schat/system_info.proto
...
type SystemInfo struct {
	ConversationCount uint64 `protobuf:"varint,1,opt,name=conversationCount,proto3" json:"conversationCount,omitempty"`
}
...
func (*SystemInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_a053c75bd516035c, []int{0}
}
...
func (m *SystemInfo) GetConversationCount() uint64 {
	if m != nil {
		return m.ConversationCount
	}
	return 0
}

func init() {
	proto.RegisterType((*SystemInfo)(nil), "chengyu97.schat.schat.SystemInfo")
}

func init() { proto.RegisterFile("schat/system_info.proto", fileDescriptor_a053c75bd516035c) }

var fileDescriptor_a053c75bd516035c = []byte{
	// 173 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2f, 0x4e, 0xce, 0x48,
	0x2c, 0xd1, 0x2f, 0xae, 0x2c, 0x2e, 0x49, 0xcd, 0x8d, 0xcf, 0xcc, 0x4b, 0xcb, 0xd7, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4d, 0xce, 0x48, 0xcd, 0x4b, 0xaf, 0x2c, 0xb5, 0x34, 0xd7, 0x03,
	0x2b, 0x81, 0x90, 0x4a, 0x56, 0x5c, 0x5c, 0xc1, 0x60, 0xb5, 0x9e, 0x79, 0x69, 0xf9, 0x42, 0x3a,
	0x5c, 0x82, 0xc9, 0xf9, 0x79, 0x65, 0xa9, 0x45, 0xc5, 0x89, 0x25, 0x99, 0xf9, 0x79, 0xce, 0xf9,
	0xa5, 0x79, 0x25, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x98, 0x12, 0x4e, 0x4e, 0x27, 0x1e,
	...
	0x97, 0x9c, 0x9f, 0xab, 0xef, 0x0c, 0xb2, 0x37, 0xb2, 0xd4, 0xd2, 0x5c, 0x3f, 0xd8, 0x19, 0xe4,
	0xb4, 0x0a, 0x7d, 0x88, 0x13, 0x4b, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xae, 0x33, 0x06,
	0x04, 0x00, 0x00, 0xff, 0xff, 0x21, 0x33, 0xcd, 0x5d, 0xb8, 0x00, 0x00, 0x00,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ConversationCount != 0 {
		i = encodeVarintSystemInfo(dAtA, i, uint64(m.ConversationCount))
		i--
		dAtA[i] = 0x8
	}
...
func (m *SystemInfo) Size() (n int) {
	...
	_ = l
	if m.ConversationCount != 0 {
		n += 1 + sovSystemInfo(uint64(m.ConversationCount))
	}
	return n
}
...
func (m *SystemInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConversationCount", wireType)
			}
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConversationCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
