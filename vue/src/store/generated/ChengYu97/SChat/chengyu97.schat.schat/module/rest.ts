...
export interface SchatEncryptKey {
  address?: string;
  key?: string;
}
...
export interface SchatQueryAllEncryptKeyResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryEncryptKeyAll
   * @summary Queries a list of EncryptKey items.
   * @request GET:/ChengYu97/SChat/schat/encrypt_key
   */
  queryEncryptKeyAll = (
    query?: {
    ...
    this.request<SchatQueryAllEncryptKeyResponse, RpcStatus>({
      path: `/ChengYu97/SChat/schat/encrypt_key`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryEncryptKey
   * @summary Queries a EncryptKey by index.
   * @request GET:/ChengYu97/SChat/schat/encrypt_key/{address}
   */
  queryEncryptKey = (address: string, params: RequestParams = {}) =>
    this.request<SchatQueryGetEncryptKeyResponse, RpcStatus>({
      path: `/ChengYu97/SChat/schat/encrypt_key/${address}`,
      method: "GET",
      format: "json",
      ...params,
    });
